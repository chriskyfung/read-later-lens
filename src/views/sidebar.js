...
export function renderSidebarFolders() {
  ...
  if (folderList) {
    ...
    sourceFiles.forEach((file) => {
      ...
      btn.innerHTML = `
        <div class="flex items-center space-x-2 truncate flex-1" onclick="selectFolder('${file.id}')">
        ...
        <div class="flex items-center space-x-1 shrink-0">
            ...
            <button onclick="confirmDeleteFolder(event, '${file.id}')" class="hidden group-hover:block text-slate-400 hover:text-rose-400 p-1" title="刪除檔案與其書籤">
